...
class RolesApi
{
     ...
     */
    public function createRole($x_request_id, $create_role_request, $x_trace_id = null)
    {
        list($response) = $this->createRoleWithHttpInfo($x_request_id, $create_role_request, $x_trace_id);
        return $response;
    }
     ...
     */
    public function createRoleWithHttpInfo($x_request_id, $create_role_request, $x_trace_id = null)
    {
        $request = $this->createRoleRequest($x_request_id, $create_role_request, $x_trace_id);
     ...
     */
    public function createRoleAsync($x_request_id, $create_role_request, $x_trace_id = null)
    {
        return $this->createRoleAsyncWithHttpInfo($x_request_id, $create_role_request, $x_trace_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createRoleAsyncWithHttpInfo($x_request_id, $create_role_request, $x_trace_id = null)
    {
        $returnType = '\OpenAPI\Client\Model\CreateRoleResponse';
        $request = $this->createRoleRequest($x_request_id, $create_role_request, $x_trace_id);
     ...
     */
    public function createRoleRequest($x_request_id, $create_role_request, $x_trace_id = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteRoleRequest($x_request_id, $role_id, $x_trace_id = null)
    {
        // verify the required parameter 'x_request_id' is set
        if ($x_request_id === null || (is_array($x_request_id) && count($x_request_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveApiPermissionsListRequest($x_request_id, $x_trace_id = null, $page = null, $size = null, $order_by = null, $api_name = null)
    {
        // verify the required parameter 'x_request_id' is set
        if ($x_request_id === null || (is_array($x_request_id) && count($x_request_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveRoleRequest($x_request_id, $role_id, $x_trace_id = null)
    {
        // verify the required parameter 'x_request_id' is set
        if ($x_request_id === null || (is_array($x_request_id) && count($x_request_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveRoleListRequest($x_request_id, $x_trace_id = null, $page = null, $size = null, $order_by = null, $name = null, $api_name = null, $tag_name = null, $type = null)
    {
        // verify the required parameter 'x_request_id' is set
        if ($x_request_id === null || (is_array($x_request_id) && count($x_request_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function updateRole($x_request_id, $role_id, $update_role_request, $x_trace_id = null)
    {
        list($response) = $this->updateRoleWithHttpInfo($x_request_id, $role_id, $update_role_request, $x_trace_id);
        return $response;
    }
     ...
     */
    public function updateRoleWithHttpInfo($x_request_id, $role_id, $update_role_request, $x_trace_id = null)
    {
        $request = $this->updateRoleRequest($x_request_id, $role_id, $update_role_request, $x_trace_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateRoleAsync($x_request_id, $role_id, $update_role_request, $x_trace_id = null)
    {
        return $this->updateRoleAsyncWithHttpInfo($x_request_id, $role_id, $update_role_request, $x_trace_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateRoleAsyncWithHttpInfo($x_request_id, $role_id, $update_role_request, $x_trace_id = null)
    {
        $returnType = '\OpenAPI\Client\Model\UpdateRoleResponse';
        $request = $this->updateRoleRequest($x_request_id, $role_id, $update_role_request, $x_trace_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateRoleRequest($x_request_id, $role_id, $update_role_request, $x_trace_id = null)
    {
        // verify the required parameter 'x_request_id' is set
        if ($x_request_id === null || (is_array($x_request_id) && count($x_request_id) === 0)) {
            throw new \InvalidArgumentException(
