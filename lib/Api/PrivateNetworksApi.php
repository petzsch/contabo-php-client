...
/**
     ...
     */
    public function retrievePrivateNetworkList($x_request_id, $x_trace_id = null, $page = null, $size = null, $order_by = null, $name = null, $instance_ids = null, string $contentType = self::contentTypes['retrievePrivateNetworkList'][0])
    {
        list($response) = $this->retrievePrivateNetworkListWithHttpInfo($x_request_id, $x_trace_id, $page, $size, $order_by, $name, $instance_ids, $contentType);
        return $response;
    }
     ...
     */
    public function retrievePrivateNetworkListWithHttpInfo($x_request_id, $x_trace_id = null, $page = null, $size = null, $order_by = null, $name = null, $instance_ids = null, string $contentType = self::contentTypes['retrievePrivateNetworkList'][0])
    {
        $request = $this->retrievePrivateNetworkListRequest($x_request_id, $x_trace_id, $page, $size, $order_by, $name, $instance_ids, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrievePrivateNetworkListAsync($x_request_id, $x_trace_id = null, $page = null, $size = null, $order_by = null, $name = null, $instance_ids = null, string $contentType = self::contentTypes['retrievePrivateNetworkList'][0])
    {
        return $this->retrievePrivateNetworkListAsyncWithHttpInfo($x_request_id, $x_trace_id, $page, $size, $order_by, $name, $instance_ids, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrievePrivateNetworkListAsyncWithHttpInfo($x_request_id, $x_trace_id = null, $page = null, $size = null, $order_by = null, $name = null, $instance_ids = null, string $contentType = self::contentTypes['retrievePrivateNetworkList'][0])
    {
        $returnType = '\OpenAPI\Client\Model\ListPrivateNetworkResponse';
        $request = $this->retrievePrivateNetworkListRequest($x_request_id, $x_trace_id, $page, $size, $order_by, $name, $instance_ids, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrievePrivateNetworkListRequest($x_request_id, $x_trace_id = null, $page = null, $size = null, $order_by = null, $name = null, $instance_ids = null, string $contentType = self::contentTypes['retrievePrivateNetworkList'][0])
    {
