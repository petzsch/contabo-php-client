...
class PrivateNetworksApi
{
     ...
     */
    public function assignInstancePrivateNetworkRequest($x_request_id, $private_network_id, $instance_id, $x_trace_id = null)
    {
     ...
     */
    public function createPrivateNetwork($x_request_id, $create_private_network_request, $x_trace_id = null)
    {
        list($response) = $this->createPrivateNetworkWithHttpInfo($x_request_id, $create_private_network_request, $x_trace_id);
        return $response;
    }
     ...
     */
    public function createPrivateNetworkWithHttpInfo($x_request_id, $create_private_network_request, $x_trace_id = null)
    {
        $request = $this->createPrivateNetworkRequest($x_request_id, $create_private_network_request, $x_trace_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createPrivateNetworkAsync($x_request_id, $create_private_network_request, $x_trace_id = null)
    {
        return $this->createPrivateNetworkAsyncWithHttpInfo($x_request_id, $create_private_network_request, $x_trace_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createPrivateNetworkAsyncWithHttpInfo($x_request_id, $create_private_network_request, $x_trace_id = null)
    {
        $returnType = '\OpenAPI\Client\Model\CreatePrivateNetworkResponse';
        $request = $this->createPrivateNetworkRequest($x_request_id, $create_private_network_request, $x_trace_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createPrivateNetworkRequest($x_request_id, $create_private_network_request, $x_trace_id = null)
    {
        // verify the required parameter 'x_request_id' is set
        if ($x_request_id === null || (is_array($x_request_id) && count($x_request_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($create_private_network_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($create_private_network_request));
            } else {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deletePrivateNetworkRequest($x_request_id, $private_network_id, $x_trace_id = null)
    {
        // verify the required parameter 'x_request_id' is set
        if ($x_request_id === null || (is_array($x_request_id) && count($x_request_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function patchPrivateNetwork($x_request_id, $private_network_id, $patch_private_network_request, $x_trace_id = null)
    {
        list($response) = $this->patchPrivateNetworkWithHttpInfo($x_request_id, $private_network_id, $patch_private_network_request, $x_trace_id);
        return $response;
    }
     ...
     */
    public function patchPrivateNetworkWithHttpInfo($x_request_id, $private_network_id, $patch_private_network_request, $x_trace_id = null)
    {
        $request = $this->patchPrivateNetworkRequest($x_request_id, $private_network_id, $patch_private_network_request, $x_trace_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchPrivateNetworkAsync($x_request_id, $private_network_id, $patch_private_network_request, $x_trace_id = null)
    {
        return $this->patchPrivateNetworkAsyncWithHttpInfo($x_request_id, $private_network_id, $patch_private_network_request, $x_trace_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchPrivateNetworkAsyncWithHttpInfo($x_request_id, $private_network_id, $patch_private_network_request, $x_trace_id = null)
    {
        $returnType = '\OpenAPI\Client\Model\PatchPrivateNetworkResponse';
        $request = $this->patchPrivateNetworkRequest($x_request_id, $private_network_id, $patch_private_network_request, $x_trace_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchPrivateNetworkRequest($x_request_id, $private_network_id, $patch_private_network_request, $x_trace_id = null)
    {
        // verify the required parameter 'x_request_id' is set
        if ($x_request_id === null || (is_array($x_request_id) && count($x_request_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($patch_private_network_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($patch_private_network_request));
            } else {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrievePrivateNetworkRequest($x_request_id, $private_network_id, $x_trace_id = null)
    {
        // verify the required parameter 'x_request_id' is set
        if ($x_request_id === null || (is_array($x_request_id) && count($x_request_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function retrievePrivateNetworkList($x_request_id, $x_trace_id = null, $page = null, $size = null, $order_by = null, $name = null, $instance_ids = null)
    {
        list($response) = $this->retrievePrivateNetworkListWithHttpInfo($x_request_id, $x_trace_id, $page, $size, $order_by, $name, $instance_ids);
        return $response;
    }
     ...
     */
    public function retrievePrivateNetworkListWithHttpInfo($x_request_id, $x_trace_id = null, $page = null, $size = null, $order_by = null, $name = null, $instance_ids = null)
    {
        $request = $this->retrievePrivateNetworkListRequest($x_request_id, $x_trace_id, $page, $size, $order_by, $name, $instance_ids);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrievePrivateNetworkListAsync($x_request_id, $x_trace_id = null, $page = null, $size = null, $order_by = null, $name = null, $instance_ids = null)
    {
        return $this->retrievePrivateNetworkListAsyncWithHttpInfo($x_request_id, $x_trace_id, $page, $size, $order_by, $name, $instance_ids)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrievePrivateNetworkListAsyncWithHttpInfo($x_request_id, $x_trace_id = null, $page = null, $size = null, $order_by = null, $name = null, $instance_ids = null)
    {
        $returnType = '\OpenAPI\Client\Model\ListPrivateNetworkResponse';
        $request = $this->retrievePrivateNetworkListRequest($x_request_id, $x_trace_id, $page, $size, $order_by, $name, $instance_ids);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrievePrivateNetworkListRequest($x_request_id, $x_trace_id = null, $page = null, $size = null, $order_by = null, $name = null, $instance_ids = null)
    {
        // verify the required parameter 'x_request_id' is set
        if ($x_request_id === null || (is_array($x_request_id) && count($x_request_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function unassignInstancePrivateNetworkRequest($x_request_id, $private_network_id, $instance_id, $x_trace_id = null)
    {
        // verify the required parameter 'x_request_id' is set
        if ($x_request_id === null || (is_array($x_request_id) && count($x_request_id) === 0)) {
            throw new \InvalidArgumentException(
