...
/**
     ...
     */
    public function listObjectStorageCredentials($x_request_id, $user_id, $x_trace_id = null, $page = null, $size = null, $order_by = null, $object_storage_id = null, string $contentType = self::contentTypes['listObjectStorageCredentials'][0])
    {
        list($response) = $this->listObjectStorageCredentialsWithHttpInfo($x_request_id, $user_id, $x_trace_id, $page, $size, $order_by, $object_storage_id, $contentType);
        return $response;
    }
     ...
     */
    public function listObjectStorageCredentialsWithHttpInfo($x_request_id, $user_id, $x_trace_id = null, $page = null, $size = null, $order_by = null, $object_storage_id = null, string $contentType = self::contentTypes['listObjectStorageCredentials'][0])
    {
        $request = $this->listObjectStorageCredentialsRequest($x_request_id, $user_id, $x_trace_id, $page, $size, $order_by, $object_storage_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listObjectStorageCredentialsAsync($x_request_id, $user_id, $x_trace_id = null, $page = null, $size = null, $order_by = null, $object_storage_id = null, string $contentType = self::contentTypes['listObjectStorageCredentials'][0])
    {
        return $this->listObjectStorageCredentialsAsyncWithHttpInfo($x_request_id, $user_id, $x_trace_id, $page, $size, $order_by, $object_storage_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listObjectStorageCredentialsAsyncWithHttpInfo($x_request_id, $user_id, $x_trace_id = null, $page = null, $size = null, $order_by = null, $object_storage_id = null, string $contentType = self::contentTypes['listObjectStorageCredentials'][0])
    {
        $returnType = '\OpenAPI\Client\Model\ListCredentialResponse';
        $request = $this->listObjectStorageCredentialsRequest($x_request_id, $user_id, $x_trace_id, $page, $size, $order_by, $object_storage_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listObjectStorageCredentialsRequest($x_request_id, $user_id, $x_trace_id = null, $page = null, $size = null, $order_by = null, $object_storage_id = null, string $contentType = self::contentTypes['listObjectStorageCredentials'][0])
    {
     ...
     * @param  int $credential_id The ID of the object storage credential (required)
     * @param  string $x_trace_id Identifier to trace group of requests. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['regenerateCredentials'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\FindCredentialResponse
     */
    public function regenerateCredentials($x_request_id, $user_id, $object_storage_id, $credential_id, $x_trace_id = null, string $contentType = self::contentTypes['regenerateCredentials'][0])
    {
        list($response) = $this->regenerateCredentialsWithHttpInfo($x_request_id, $user_id, $object_storage_id, $credential_id, $x_trace_id, $contentType);
        return $response;
    }
     ...
     * @return array of \OpenAPI\Client\Model\FindCredentialResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function regenerateCredentialsWithHttpInfo($x_request_id, $user_id, $object_storage_id, $credential_id, $x_trace_id = null, string $contentType = self::contentTypes['regenerateCredentials'][0])
    {
        $request = $this->regenerateCredentialsRequest($x_request_id, $user_id, $object_storage_id, $credential_id, $x_trace_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function regenerateCredentialsAsync($x_request_id, $user_id, $object_storage_id, $credential_id, $x_trace_id = null, string $contentType = self::contentTypes['regenerateCredentials'][0])
    {
        return $this->regenerateCredentialsAsyncWithHttpInfo($x_request_id, $user_id, $object_storage_id, $credential_id, $x_trace_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function regenerateCredentialsAsyncWithHttpInfo($x_request_id, $user_id, $object_storage_id, $credential_id, $x_trace_id = null, string $contentType = self::contentTypes['regenerateCredentials'][0])
    {
        $returnType = '\OpenAPI\Client\Model\FindCredentialResponse';
        $request = $this->regenerateCredentialsRequest($x_request_id, $user_id, $object_storage_id, $credential_id, $x_trace_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function regenerateCredentialsRequest($x_request_id, $user_id, $object_storage_id, $credential_id, $x_trace_id = null, string $contentType = self::contentTypes['regenerateCredentials'][0])
    {
        ...
        if ($object_storage_id === null || (is_array($object_storage_id) && count($object_storage_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $object_storage_id when calling regenerateCredentials'
            );
        }
        ...
        if ($credential_id === null || (is_array($credential_id) && count($credential_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $credential_id when calling regenerateCredentials'
            );
        }
