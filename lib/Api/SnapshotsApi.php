...
/**
    ...
    public function createSnapshotWithHttpInfo($x_request_id, $instance_id, $create_snapshot_request, $x_trace_id = null, string $contentType = self::contentTypes['createSnapshot'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\OpenAPI\Client\Model\CreateSnapshotResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\CreateSnapshotResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\CreateSnapshotResponse', []),
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\CreateSnapshotResponse',
    ...
    public function createSnapshotRequest($x_request_id, $instance_id, $create_snapshot_request, $x_trace_id = null, string $contentType = self::contentTypes['createSnapshot'][0])
    {
        ...
        if ($x_request_id === null || (is_array($x_request_id) && count($x_request_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_request_id when calling createSnapshot'
            );
        }
    ...
    public function deleteSnapshotRequest($x_request_id, $instance_id, $snapshot_id, $x_trace_id = null, string $contentType = self::contentTypes['deleteSnapshot'][0])
    {
        ...
        if ($x_request_id === null || (is_array($x_request_id) && count($x_request_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_request_id when calling deleteSnapshot'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $x_request_id)) {
    ...
    /**
     * Operation retrieveSnapshotWithHttpInfo
     *
     * Retrieve a specific snapshot by id
     *
     * @param  string $x_request_id [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
    ...
    public function retrieveSnapshotWithHttpInfo($x_request_id, $instance_id, $snapshot_id, $x_trace_id = null, string $contentType = self::contentTypes['retrieveSnapshot'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\FindSnapshotResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\FindSnapshotResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\FindSnapshotResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\FindSnapshotResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation retrieveSnapshotAsync
     *
     * Retrieve a specific snapshot by id
     *
     * @param  string $x_request_id [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
    ...
    /**
     * Operation retrieveSnapshotAsyncWithHttpInfo
     *
     * Retrieve a specific snapshot by id
     *
     * @param  string $x_request_id [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
    ...
    /**
     * Create request for operation 'retrieveSnapshot'
     *
     * @param  string $x_request_id [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     * @param  int $instance_id The identifier of the instance (required)
     * @param  string $snapshot_id The identifier of the snapshot (required)
    ...
    public function retrieveSnapshotRequest($x_request_id, $instance_id, $snapshot_id, $x_trace_id = null, string $contentType = self::contentTypes['retrieveSnapshot'][0])
    {
        ...
        if ($x_request_id === null || (is_array($x_request_id) && count($x_request_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_request_id when calling retrieveSnapshot'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $x_request_id)) {
    ...
    /**
     * Operation retrieveSnapshotList
     *
     * List snapshots
     *
     * @param  string $x_request_id [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
    ...
    /**
     * Operation retrieveSnapshotListWithHttpInfo
     *
     * List snapshots
     *
     * @param  string $x_request_id [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
    ...
    public function retrieveSnapshotListWithHttpInfo($x_request_id, $instance_id, $x_trace_id = null, $page = null, $size = null, $order_by = null, $name = null, string $contentType = self::contentTypes['retrieveSnapshotList'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ListSnapshotResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ListSnapshotResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ListSnapshotResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\ListSnapshotResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation retrieveSnapshotListAsync
     *
     * List snapshots
     *
     * @param  string $x_request_id [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
    ...
    /**
     * Operation retrieveSnapshotListAsyncWithHttpInfo
     *
     * List snapshots
     *
     * @param  string $x_request_id [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
    ...
    /**
     * Create request for operation 'retrieveSnapshotList'
     *
     * @param  string $x_request_id [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     * @param  int $instance_id The identifier of the instance (required)
     * @param  string $x_trace_id Identifier to trace group of requests. (optional)
    ...
    public function retrieveSnapshotListRequest($x_request_id, $instance_id, $x_trace_id = null, $page = null, $size = null, $order_by = null, $name = null, string $contentType = self::contentTypes['retrieveSnapshotList'][0])
    {
        ...
        if ($x_request_id === null || (is_array($x_request_id) && count($x_request_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_request_id when calling retrieveSnapshotList'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $x_request_id)) {
     ...
     */
    public function rollbackSnapshot($x_request_id, $instance_id, $snapshot_id, $body, $x_trace_id = null, string $contentType = self::contentTypes['rollbackSnapshot'][0])
    {
        list($response) = $this->rollbackSnapshotWithHttpInfo($x_request_id, $instance_id, $snapshot_id, $body, $x_trace_id, $contentType);
        return $response;
    }
     ...
     */
    public function rollbackSnapshotWithHttpInfo($x_request_id, $instance_id, $snapshot_id, $body, $x_trace_id = null, string $contentType = self::contentTypes['rollbackSnapshot'][0])
    {
        $request = $this->rollbackSnapshotRequest($x_request_id, $instance_id, $snapshot_id, $body, $x_trace_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\RollbackSnapshotResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\RollbackSnapshotResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\RollbackSnapshotResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\RollbackSnapshotResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function rollbackSnapshotAsync($x_request_id, $instance_id, $snapshot_id, $body, $x_trace_id = null, string $contentType = self::contentTypes['rollbackSnapshot'][0])
    {
        return $this->rollbackSnapshotAsyncWithHttpInfo($x_request_id, $instance_id, $snapshot_id, $body, $x_trace_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function rollbackSnapshotAsyncWithHttpInfo($x_request_id, $instance_id, $snapshot_id, $body, $x_trace_id = null, string $contentType = self::contentTypes['rollbackSnapshot'][0])
    {
        $returnType = '\OpenAPI\Client\Model\RollbackSnapshotResponse';
        $request = $this->rollbackSnapshotRequest($x_request_id, $instance_id, $snapshot_id, $body, $x_trace_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function rollbackSnapshotRequest($x_request_id, $instance_id, $snapshot_id, $body, $x_trace_id = null, string $contentType = self::contentTypes['rollbackSnapshot'][0])
    {

        // verify the required parameter 'x_request_id' is set
        if ($x_request_id === null || (is_array($x_request_id) && count($x_request_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_request_id when calling rollbackSnapshot'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $x_request_id)) {
        ...
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling rollbackSnapshot'
            );
        }
    ...
    public function updateSnapshotWithHttpInfo($x_request_id, $instance_id, $snapshot_id, $update_snapshot_request, $x_trace_id = null, string $contentType = self::contentTypes['updateSnapshot'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\UpdateSnapshotResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\UpdateSnapshotResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\UpdateSnapshotResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\UpdateSnapshotResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function updateSnapshotRequest($x_request_id, $instance_id, $snapshot_id, $update_snapshot_request, $x_trace_id = null, string $contentType = self::contentTypes['updateSnapshot'][0])
    {
        ...
        if ($x_request_id === null || (is_array($x_request_id) && count($x_request_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_request_id when calling updateSnapshot'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $x_request_id)) {
