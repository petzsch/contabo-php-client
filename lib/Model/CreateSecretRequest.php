...
/**
 * CreateSecretRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateSecretRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets name
     *
     * @param string $name The name of the secret that will keep the password
     *
     * @return self
     */
    public function setName($name)
    {
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateSecretRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateSecretRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setValue($value)
    {
        ...
        if ((mb_strlen($value) < 8)) {
            throw new \InvalidArgumentException('invalid length for $value when calling CreateSecretRequest., must be bigger than or equal to 8.');
        }
     ...
     * Sets type
     *
     * @param string $type The type of the secret. Can be `password` or `ssh`
     *
     * @return self
     */
