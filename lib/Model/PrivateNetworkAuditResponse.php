...
/**
 * PrivateNetworkAuditResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PrivateNetworkAuditResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PrivateNetworkAuditResponse';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['private_network_id'] === null) {
            $invalidProperties[] = "'private_network_id' can't be null";
        }
        if (($this->container['private_network_id'] < 0)) {
            $invalidProperties[] = "invalid value for 'private_network_id', must be bigger than or equal to 0.";
        }
     ...
     * Sets id
     *
     * @param int $id The identifier of the audit entry.
     *
     * @return self
     */
     ...
     *
     * @param float $private_network_id The identifier of the Private Network
     *
     * @return self
     */
    public function setPrivateNetworkId($private_network_id)
    {
        ...
        if (($private_network_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $private_network_id when calling PrivateNetworkAuditResponse., must be bigger than or equal to 0.');
        }
     ...
     * Sets timestamp
     *
     * @param \DateTime $timestamp When the change took place.
     *
     * @return self
     */
     ...
     * Sets tenant_id
     *
     * @param string $tenant_id Customer tenant id
     *
     * @return self
     */
    public function setTenantId($tenant_id)
    {
        ...
        if ((mb_strlen($tenant_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenant_id when calling PrivateNetworkAuditResponse., must be bigger than or equal to 1.');
        }
     ...
     * Sets customer_id
     *
     * @param string $customer_id Customer number
     *
     * @return self
     */
    public function setCustomerId($customer_id)
    {
        ...
        if ((mb_strlen($customer_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_id when calling PrivateNetworkAuditResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setChangedBy($changed_by)
    {
        ...
        if ((mb_strlen($changed_by) < 1)) {
            throw new \InvalidArgumentException('invalid length for $changed_by when calling PrivateNetworkAuditResponse., must be bigger than or equal to 1.');
        }
     ...
     * Sets username
     *
     * @param string $username User name which did the change.
     *
     * @return self
     */
     ...
     * Sets request_id
     *
     * @param string $request_id The requestId of the API call which led to the change.
     *
     * @return self
     */
     ...
     * Sets trace_id
     *
     * @param string $trace_id The traceId of the API call which led to the change.
     *
     * @return self
     */
     ...
     * Sets changes
     *
     * @param object|null $changes List of actual changes.
     *
     * @return self
     */
