    ...
    */
    ...
    public function setSubject($subject)
    {
        ...
        if ((mb_strlen($subject) < 1)) {
            throw new \InvalidArgumentException('invalid length for $subject when calling CreateTicketRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets note
     *
     * @param string $note The ticket note
     *
     * @return self
     */
    public function setNote($note)
    {
        ...
        if ((mb_strlen($note) < 1)) {
            throw new \InvalidArgumentException('invalid length for $note when calling CreateTicketRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets sender
     *
     * @param string $sender Customer email
     *
     * @return self
     */
    public function setSender($sender)
    {
        ...
        if ((mb_strlen($sender) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sender when calling CreateTicketRequest., must be bigger than or equal to 1.');
        }
