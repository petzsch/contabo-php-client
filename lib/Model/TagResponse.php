    ...
    */
    ...
    public function setTenantId($tenant_id)
    {
        ...
        if ((mb_strlen($tenant_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenant_id when calling TagResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customer_id)
    {
        ...
        if ((mb_strlen($customer_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_id when calling TagResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling TagResponse., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling TagResponse., must be bigger than or equal to 1.');
        }
     ...
     * Sets color
     *
     * @param string $color Tag's color
     *
     * @return self
     */
    public function setColor($color)
    {
        ...
        if ((mb_strlen($color) > 7)) {
            throw new \InvalidArgumentException('invalid length for $color when calling TagResponse., must be smaller than or equal to 7.');
        }
        if ((mb_strlen($color) < 4)) {
            throw new \InvalidArgumentException('invalid length for $color when calling TagResponse., must be bigger than or equal to 4.');
        }
