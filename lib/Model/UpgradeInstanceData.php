...
/**
 * UpgradeInstanceData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpgradeInstanceData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['addons_ids'] = $data['addons_ids'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['addons_ids'] === null) {
            $invalidProperties[] = "'addons_ids' can't be null";
        }
    ...
    public function setTenantId($tenant_id)
    {
        ...
        if ((mb_strlen($tenant_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenant_id when calling UpgradeInstanceData., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customer_id)
    {
        ...
        if ((mb_strlen($customer_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_id when calling UpgradeInstanceData., must be bigger than or equal to 1.');
        }
     ...
     * Sets instance_id
     *
     * @param int $instance_id Instance's id
     *
     * @return self
     */
     ...
     * Sets created_date
     *
     * @param \DateTime $created_date Creation date for instance
     *
     * @return self
     */
     ...
     * Sets addons_ids
     *
     * @param int[] $addons_ids List (Array) of addons as `addonId` added to instance.
     *
     * @return self
     */
