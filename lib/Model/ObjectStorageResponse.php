...
/**
 * ObjectStorageResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ObjectStorageResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ObjectStorageResponse';
    ...
    */
    ...
    public function setTenantId($tenant_id)
    {
        ...
        if ((mb_strlen($tenant_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenant_id when calling ObjectStorageResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customer_id)
    {
        ...
        if ((mb_strlen($customer_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_id when calling ObjectStorageResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setObjectStorageId($object_storage_id)
    {
        ...
        if ((mb_strlen($object_storage_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $object_storage_id when calling ObjectStorageResponse., must be bigger than or equal to 1.');
        }
     ...
     * Sets data_center
     *
     * @param string $data_center Data center your object storage is located
     *
     * @return self
     */
    public function setDataCenter($data_center)
    {
        ...
        if ((mb_strlen($data_center) < 1)) {
            throw new \InvalidArgumentException('invalid length for $data_center when calling ObjectStorageResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setDisplayName($display_name)
    {
        ...
        if ((mb_strlen($display_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $display_name when calling ObjectStorageResponse., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($display_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $display_name when calling ObjectStorageResponse., must be bigger than or equal to 1.');
        }
