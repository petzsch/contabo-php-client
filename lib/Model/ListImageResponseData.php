 ...
 */
class ListImageResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListImageResponseData';
    ...
    protected static $openAPITypes = [
        ...
        'tags' => '\OpenAPI\Client\Model\TagResponse1[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['size_mb'] = $data['size_mb'] ?? null;
        $this->container['uploaded_size_mb'] = $data['uploaded_size_mb'] ?? null;
        $this->container['os_type'] = $data['os_type'] ?? null;
        $this->container['version'] = $data['version'] ?? null;
        $this->container['format'] = $data['format'] ?? null;
        $this->container['status'] = $data['status'] ?? null;
        $this->container['error_message'] = $data['error_message'] ?? null;
        $this->container['standard_image'] = $data['standard_image'] ?? null;
    ...
    public function setTenantId($tenant_id)
    {
        ...
        if ((mb_strlen($tenant_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenant_id when calling ListImageResponseData., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customer_id)
    {
        ...
        if ((mb_strlen($customer_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_id when calling ListImageResponseData., must be bigger than or equal to 1.');
        }
     ...
     * Gets tags
     *
     * @return \OpenAPI\Client\Model\TagResponse1[]
     */
     ...
     * Sets tags
     *
     * @param \OpenAPI\Client\Model\TagResponse1[] $tags The tags assigned to the image
     *
     * @return self
     */
