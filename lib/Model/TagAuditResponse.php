...
/**
 * TagAuditResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TagAuditResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TagAuditResponse';
    ...
    public function setTenantId($tenant_id)
    {
        ...
        if ((mb_strlen($tenant_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenant_id when calling TagAuditResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customer_id)
    {
        ...
        if ((mb_strlen($customer_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_id when calling TagAuditResponse., must be bigger than or equal to 1.');
        }
     ...
     * Sets tag_id
     *
     * @param float $tag_id The identifier of the tag
     *
     * @return self
     */
    public function setTagId($tag_id)
    {
        ...
        if (($tag_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $tag_id when calling TagAuditResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setChangedBy($changed_by)
    {
        ...
        if ((mb_strlen($changed_by) < 1)) {
            throw new \InvalidArgumentException('invalid length for $changed_by when calling TagAuditResponse., must be bigger than or equal to 1.');
        }
