...
/**
 * InstanceResetPasswordActionResponseData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InstanceResetPasswordActionResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InstanceResetPasswordActionResponseData';
    ...
    */
    ...
    public function setTenantId($tenant_id)
    {
        ...
        if ((mb_strlen($tenant_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenant_id when calling InstanceResetPasswordActionResponseData., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customer_id)
    {
        ...
        if ((mb_strlen($customer_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_id when calling InstanceResetPasswordActionResponseData., must be bigger than or equal to 1.');
        }
     ...
     * Sets instance_id
     *
     * @param int $instance_id Compute instance / resource id
     *
     * @return self
     */
     ...
     * Sets action
     *
     * @param string $action Action that was triggered
     *
     * @return self
     */
