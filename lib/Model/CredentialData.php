...
/**
 * CredentialData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CredentialData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CredentialData';
    ...
    */
    ...
    public function setTenantId($tenant_id)
    {
        ...
        if ((mb_strlen($tenant_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenant_id when calling CredentialData., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customer_id)
    {
        ...
        if ((mb_strlen($customer_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_id when calling CredentialData., must be bigger than or equal to 1.');
        }
     ...
     * Sets secret_key
     *
     * @param string $secret_key Secret key ID.
     *
     * @return self
     */
     ...
     * Sets display_name
     *
     * @param string $display_name Object Storage Name.
     *
     * @return self
     */
     ...
     * Sets credential_id
     *
     * @param float $credential_id Object Storage Credential ID
     *
     * @return self
     */
