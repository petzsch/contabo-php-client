...
/**
 * InstancesActionsRescueRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InstancesActionsRescueRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InstancesActionsRescueRequest';
    ...
    */
     ...
     * Sets root_password
     *
     * @param int|null $root_password `secretId` of the password to login into rescue system for the `root` user.
     *
     * @return self
     */
     ...
     * Sets ssh_keys
     *
     * @param int[]|null $ssh_keys Array of `secretId`s of public SSH keys for logging into rescue system as `root` user.
     *
     * @return self
     */
