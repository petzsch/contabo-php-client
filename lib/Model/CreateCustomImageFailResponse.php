...
/**
 * CreateCustomImageFailResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateCustomImageFailResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateCustomImageFailResponse';
    ...
    */
     ...
     * Sets message
     *
     * @param string $message Unsupported Media Type: Please provide a direct link to an .iso or .qcow2 image.
     *
     * @return self
     */
     ...
     * Sets status_code
     *
     * @param int $status_code statuscode:415
     *
     * @return self
     */
