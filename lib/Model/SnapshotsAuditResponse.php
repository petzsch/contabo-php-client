...
/**
 * SnapshotsAuditResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SnapshotsAuditResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SnapshotsAuditResponse';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['changed_by'] = $data['changed_by'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['instance_id'] < 0)) {
            $invalidProperties[] = "invalid value for 'instance_id', must be bigger than or equal to 0.";
        }
    ...
    public function setTenantId($tenant_id)
    {
        ...
        if ((mb_strlen($tenant_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenant_id when calling SnapshotsAuditResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customer_id)
    {
        ...
        if ((mb_strlen($customer_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_id when calling SnapshotsAuditResponse., must be bigger than or equal to 1.');
        }
     ...
     * Sets changed_by
     *
     * @param string $changed_by Id of user who performed the change
     *
     * @return self
     */
    public function setChangedBy($changed_by)
    {
        ...
        if ((mb_strlen($changed_by) < 1)) {
            throw new \InvalidArgumentException('invalid length for $changed_by when calling SnapshotsAuditResponse., must be bigger than or equal to 1.');
        }
     ...
     * Sets username
     *
     * @param string $username Name of the user which led to the change.
     *
     * @return self
     */
    ...
    public function setInstanceId($instance_id)
    {
        ...
        if (($instance_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $instance_id when calling SnapshotsAuditResponse., must be bigger than or equal to 0.');
        }
     ...
     * Sets snapshot_id
     *
     * @param string $snapshot_id The identifier of the snapshot
     *
     * @return self
     */
