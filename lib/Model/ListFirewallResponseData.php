...
/**
 * ListFirewallResponseData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ListFirewallResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListFirewallResponseData';
    ...
    protected static $openAPITypes = [
        ...
        'description' => 'string',
        'status' => 'string',
        'instance_status' => '\OpenAPI\Client\Model\InstanceStatusRepresentation[]',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('firewall_id', $data ?? [], null);
        $this->setIfExists('name', $data ?? [], null);
        $this->setIfExists('description', $data ?? [], null);
        $this->setIfExists('status', $data ?? [], null);
        $this->setIfExists('instance_status', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['instance_status'] === null) {
            $invalidProperties[] = "'instance_status' can't be null";
        }
    ...
    public function setTenantId($tenant_id)
    {
        ...
        if ((mb_strlen($tenant_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenant_id when calling ListFirewallResponseData., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customer_id)
    {
        ...
        if ((mb_strlen($customer_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_id when calling ListFirewallResponseData., must be bigger than or equal to 1.');
        }
    ...
    public function setFirewallId($firewall_id)
    {
        ...
        if ((mb_strlen($firewall_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $firewall_id when calling ListFirewallResponseData., must be bigger than or equal to 1.');
        }


        if (is_null($firewall_id)) {
            throw new \InvalidArgumentException('non-nullable firewall_id cannot be null');
        }
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ListFirewallResponseData., must be smaller than or equal to 255.');
        }
    ...
    public function setDescription($description)
    {
        if ((mb_strlen($description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $description when calling ListFirewallResponseData., must be smaller than or equal to 255.');
        }
     ...
     * Sets status
     *
     * @param string $status Inactive status means no rules of this firewall are set for all assigned instances.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\InstanceStatusRepresentation[]
     */
     ...
     *
     * @param \OpenAPI\Client\Model\InstanceStatusRepresentation[] $instance_status instance_status
     *
     * @return self
     */
    public function setInstanceStatus($instance_status)
    {
        ...
        if (is_null($instance_status)) {
            throw new \InvalidArgumentException('non-nullable instance_status cannot be null');
        }
     ...
     * Sets is_default
     *
     * @param bool $is_default The default firewall rules are assigned by default to newly created instances with Firewall Add-On if not specified otherwise. Exactly one firewall can be set as default.
     *
     * @return self
     */
