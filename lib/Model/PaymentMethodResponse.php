...
class PaymentMethodResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const PAYMENT_TYPE_CREDIT_CARD = 'Credit Card';
    public const PAYMENT_TYPE_PAYPAL = 'Paypal';
    public const PAYMENT_TYPE_PAYPAL__AUTOMATIC = 'Paypal (Automatic)';
    public const PAYMENT_TYPE_SKRILL = 'Skrill';
    public const PAYMENT_TYPE_WESTERN_UNION = 'Western Union';
    ...
    public function getPaymentTypeAllowableValues()
    {
        return [
            ...
            self::PAYMENT_TYPE_PAYPAL__AUTOMATIC,
            self::PAYMENT_TYPE_SKRILL,
            self::PAYMENT_TYPE_WESTERN_UNION,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['direct_debit'] = $data['direct_debit'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['payment_type_id']) < 1)) {
            $invalidProperties[] = "invalid value for 'payment_type_id', the character length must be bigger than or equal to 1.";
        }
        ...
        if ((mb_strlen($this->container['payment_type']) > 255)) {
            $invalidProperties[] = "invalid value for 'payment_type', the character length must be smaller than or equal to 255.";
        }

        if ((mb_strlen($this->container['payment_type']) < 1)) {
            $invalidProperties[] = "invalid value for 'payment_type', the character length must be bigger than or equal to 1.";
        }

        if ($this->container['direct_debit'] === null) {
            $invalidProperties[] = "'direct_debit' can't be null";
        }
    ...
    public function setTenantId($tenant_id)
    {
        ...
        if ((mb_strlen($tenant_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenant_id when calling PaymentMethodResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customer_id)
    {
        ...
        if ((mb_strlen($customer_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_id when calling PaymentMethodResponse., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string $payment_type_id Your paymentTypeId
     *
     * @return self
     */
    public function setPaymentTypeId($payment_type_id)
    {
        ...
        if ((mb_strlen($payment_type_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $payment_type_id when calling PaymentMethodResponse., must be bigger than or equal to 1.');
        }
     ...
     * Sets payment_type
     *
     * @param string $payment_type Current payment method
     *
     * @return self
     */
    public function setPaymentType($payment_type)
    {
        ...
        if ((mb_strlen($payment_type) > 255)) {
            throw new \InvalidArgumentException('invalid length for $payment_type when calling PaymentMethodResponse., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($payment_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $payment_type when calling PaymentMethodResponse., must be bigger than or equal to 1.');
        }
     ...
     * Sets direct_debit
     *
     * @param bool $direct_debit Indicate if payment-method is direct debit or not
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string $description description or details of the payment method
     *
     * @return self
     */
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PaymentMethodResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setLogo($logo)
    {
        ...
        if ((mb_strlen($logo) < 1)) {
            throw new \InvalidArgumentException('invalid length for $logo when calling PaymentMethodResponse., must be bigger than or equal to 1.');
        }
