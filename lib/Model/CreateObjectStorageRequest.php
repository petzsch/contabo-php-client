 ...
 */
class CreateObjectStorageRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateObjectStorageRequest';
    ...
    protected static $openAPITypes = [
        'region' => 'string',
        'auto_scaling' => '\OpenAPI\Client\Model\CreateObjectStorageRequestAutoScaling',
    ...
    */
     ...
     * Sets region
     *
     * @param string $region Region where the object storage should be located. Default is EU. Available regions: EU, US-central, SIN
     *
     * @return self
     */
    public function setRegion($region)
    {
        ...
        if ((mb_strlen($region) < 1)) {
            throw new \InvalidArgumentException('invalid length for $region when calling CreateObjectStorageRequest., must be bigger than or equal to 1.');
        }
     ...
     * Gets auto_scaling
     *
     * @return \OpenAPI\Client\Model\CreateObjectStorageRequestAutoScaling|null
     */
     ...
     * Sets auto_scaling
     *
     * @param \OpenAPI\Client\Model\CreateObjectStorageRequestAutoScaling|null $auto_scaling auto_scaling
     *
     * @return self
     */
     ...
     * Sets display_name
     *
     * @param string|null $display_name Display name helps to differentiate between object storages, especially if they are in the same region. If display name is not provided, it will be generated. Display name can be changed any time.
     *
     * @return self
     */
    public function setDisplayName($display_name)
    {
        if (!is_null($display_name) && (mb_strlen($display_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $display_name when calling CreateObjectStorageRequest., must be smaller than or equal to 255.');
        }
        if (!is_null($display_name) && (mb_strlen($display_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $display_name when calling CreateObjectStorageRequest., must be bigger than or equal to 1.');
        }
