...
/**
 * ListUserResponsePagination Class Doc Comment
 *
 * @category Class
 ...
 */
class ListUserResponsePagination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListUserResponse__pagination';
    ...
    */
     ...
     * Sets size
     *
     * @param float $size Number of elements per page.
     *
     * @return self
     */
     ...
     * Sets total_elements
     *
     * @param float $total_elements Number of overall matched elements.
     *
     * @return self
     */
     ...
     * Sets total_pages
     *
     * @param float $total_pages Overall number of pages.
     *
     * @return self
     */
     ...
     * Sets page
     *
     * @param float $page Current number of page.
     *
     * @return self
     */
