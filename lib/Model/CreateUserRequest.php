    ...
    */
    ...
    public function setFirstName($first_name)
    {
        if (!is_null($first_name) && (mb_strlen($first_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling CreateUserRequest., must be smaller than or equal to 255.');
        }
        if (!is_null($first_name) && (mb_strlen($first_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling CreateUserRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setLastName($last_name)
    {
        if (!is_null($last_name) && (mb_strlen($last_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling CreateUserRequest., must be smaller than or equal to 255.');
        }
        if (!is_null($last_name) && (mb_strlen($last_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling CreateUserRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setEmail($email)
    {
        if ((mb_strlen($email) > 255)) {
            throw new \InvalidArgumentException('invalid length for $email when calling CreateUserRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($email) < 1)) {
            throw new \InvalidArgumentException('invalid length for $email when calling CreateUserRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets enabled
     *
     * @param bool $enabled If user is not enabled, he can't login and thus use services any longer.
     *
     * @return self
     */
