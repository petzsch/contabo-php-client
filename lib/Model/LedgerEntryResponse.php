...
class LedgerEntryResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['ledger_entry_id'] = $data['ledger_entry_id'] ?? null;
        ...
        $this->container['gross_monthly_price'] = $data['gross_monthly_price'] ?? null;
        $this->container['subject'] = $data['subject'] ?? null;
        $this->container['balance_after'] = $data['balance_after'] ?? null;
        $this->container['description'] = $data['description'] ?? null;
        $this->container['currency'] = $data['currency'] ?? null;
        $this->container['gross_amount'] = $data['gross_amount'] ?? null;
