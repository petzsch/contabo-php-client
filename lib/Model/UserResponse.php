...
class UserResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'totp' => 'bool',
        'locale' => 'string',
        'roles' => '\OpenAPI\Client\Model\RoleResponse[]',
        'owner' => 'bool'
    ];
    ...
    */
    ...
    public function setTenantId($tenant_id)
    {
        ...
        if ((mb_strlen($tenant_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenant_id when calling UserResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customer_id)
    {
        ...
        if ((mb_strlen($customer_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_id when calling UserResponse., must be bigger than or equal to 1.');
        }
     ...
     * Sets first_name
     *
     * @param string $first_name The first name of the user. Users may contain letters, numbers, colons, dashes, and underscores. There is a limit of 255 characters per user.
     *
     * @return self
     */
    public function setFirstName($first_name)
    {
        ...
        if ((mb_strlen($first_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling UserResponse., must be smaller than or equal to 255.');
        }
     ...
     * Sets last_name
     *
     * @param string $last_name The last name of the user. Users may contain letters, numbers, colons, dashes, and underscores. There is a limit of 255 characters per user.
     *
     * @return self
     */
    public function setLastName($last_name)
    {
        ...
        if ((mb_strlen($last_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling UserResponse., must be smaller than or equal to 255.');
        }
     ...
     * Sets email
     *
     * @param string $email The email of the user to which activation and forgot password links are being sent to. There is a limit of 255 characters per email.
     *
     * @return self
     */
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) > 255)) {
            throw new \InvalidArgumentException('invalid length for $email when calling UserResponse., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($email) < 1)) {
            throw new \InvalidArgumentException('invalid length for $email when calling UserResponse., must be bigger than or equal to 1.');
        }
     ...
     * Sets email_verified
     *
     * @param bool $email_verified User email verification status.
     *
     * @return self
     */
     ...
     * Sets enabled
     *
     * @param bool $enabled If uses is not enabled, he can't login and thus use services any longer.
     *
     * @return self
     */
     ...
     * Sets totp
     *
     * @param bool $totp Enable or disable two-factor authentication (2FA) via time based OTP.
     *
     * @return self
     */
     ...
     * Sets locale
     *
     * @param string $locale The locale of the user. This can be `de-DE`, `de`, `en-US`, `en`
     *
     * @return self
     */
     ...
     * Gets roles
     *
     * @return \OpenAPI\Client\Model\RoleResponse[]
     */
     ...
     * Sets roles
     *
     * @param \OpenAPI\Client\Model\RoleResponse[] $roles The roles as list of `roleId`s of the user.
     *
     * @return self
     */
     ...
     * Sets owner
     *
     * @param bool $owner If user is owner he will have permissions to all API endpoints and resources. Enabling this will superseed all role definitions and `accessAllResources`.
     *
     * @return self
     */
