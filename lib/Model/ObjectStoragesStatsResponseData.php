...
/**
 * ObjectStoragesStatsResponseData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ObjectStoragesStatsResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ObjectStoragesStatsResponseData';
    ...
    protected static $setters = [
        ...
        'number_of_objects' => 'setNumberOfObjects'
    ];
    ...
    protected static $getters = [
        ...
        'number_of_objects' => 'getNumberOfObjects'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('number_of_objects', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['number_of_objects'] === null) {
            $invalidProperties[] = "'number_of_objects' can't be null";
        }
    ...
    public function setTenantId($tenant_id)
    {
        ...
        if ((mb_strlen($tenant_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenant_id when calling ObjectStoragesStatsResponseData., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customer_id)
    {
        ...
        if ((mb_strlen($customer_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_id when calling ObjectStoragesStatsResponseData., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param float $used_space_percentage Currently used space in percentage.
     *
     * @return self
     */
    public function setUsedSpacePercentage($used_space_percentage)
    {
        ...
        if (($used_space_percentage > 100)) {
            throw new \InvalidArgumentException('invalid value for $used_space_percentage when calling ObjectStoragesStatsResponseData., must be smaller than or equal to 100.');
        }
        if (($used_space_percentage < 0)) {
            throw new \InvalidArgumentException('invalid value for $used_space_percentage when calling ObjectStoragesStatsResponseData., must be bigger than or equal to 0.');
        }
    ...
    /**
     * Gets number_of_objects
     *
     * @return int
     */
    public function getNumberOfObjects()
    {
        return $this->container['number_of_objects'];
    }

    /**
     * Sets number_of_objects
     *
     * @param int $number_of_objects Number of all objects (i.e. files and folders) in object storage.
     *
     * @return self
     */
    public function setNumberOfObjects($number_of_objects)
    {
        if (is_null($number_of_objects)) {
            throw new \InvalidArgumentException('non-nullable number_of_objects cannot be null');
        }
        $this->container['number_of_objects'] = $number_of_objects;
