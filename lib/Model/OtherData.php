 ...
 */
class OtherData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OtherData';
    ...
    */
     ...
     * Sets value
     *
     * @param bool $value Toggle for other data
     *
     * @return self
     */
     ...
     * Sets text
     *
     * @param string $text Value of other data
     *
     * @return self
     */
