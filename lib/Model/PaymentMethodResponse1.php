...
/**
 * PaymentMethodResponse1 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PaymentMethodResponse1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentMethodResponse1';
    ...
    public function setTenantId($tenant_id)
    {
        ...
        if ((mb_strlen($tenant_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenant_id when calling PaymentMethodResponse1., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customer_id)
    {
        ...
        if ((mb_strlen($customer_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_id when calling PaymentMethodResponse1., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param float $payment_method_id Payment method id
     *
     * @return self
     */
    ...
    public function setPaymentMethod($payment_method)
    {
        ...
        if ((mb_strlen($payment_method) < 1)) {
            throw new \InvalidArgumentException('invalid length for $payment_method when calling PaymentMethodResponse1., must be bigger than or equal to 1.');
        }
     ...
     * Sets direct_debit
     *
     * @param bool $direct_debit Automatic debit from your payment method
     *
     * @return self
     */
