...
/**
 * FirewallAuditResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FirewallAuditResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FirewallAuditResponse';
    ...
    */
     ...
     * Sets firewall_id
     *
     * @param string $firewall_id The identifier of the Firewall
     *
     * @return self
     */
    ...
    public function setTenantId($tenant_id)
    {
        ...
        if ((mb_strlen($tenant_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenant_id when calling FirewallAuditResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customer_id)
    {
        ...
        if ((mb_strlen($customer_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_id when calling FirewallAuditResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setChangedBy($changed_by)
    {
        ...
        if ((mb_strlen($changed_by) < 1)) {
            throw new \InvalidArgumentException('invalid length for $changed_by when calling FirewallAuditResponse., must be bigger than or equal to 1.');
        }
