 ...
 */
class VipResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VipResponse';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['vip_id'] = $data['vip_id'] ?? null;
        ...
        $this->container['resource_display_name'] = $data['resource_display_name'] ?? null;
        $this->container['ip_version'] = $data['ip_version'] ?? null;
        $this->container['type'] = $data['type'] ?? null;
        $this->container['v4'] = $data['v4'] ?? null;
    }
    ...
    public function setTenantId($tenant_id)
    {
        ...
        if ((mb_strlen($tenant_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenant_id when calling VipResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customer_id)
    {
        ...
        if ((mb_strlen($customer_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_id when calling VipResponse., must be bigger than or equal to 1.');
        }
