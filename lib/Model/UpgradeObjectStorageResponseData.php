...
/**
 * UpgradeObjectStorageResponseData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpgradeObjectStorageResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpgradeObjectStorageResponseData';
    ...
    protected static $openAPITypes = [
        ...
        'created_date' => 'string',
        'data_center' => 'string',
        'auto_scaling' => '\OpenAPI\Client\Model\UpgradeObjectStorageResponseDataAutoScaling',
        's3_url' => 'string',
        'status' => 'string',
    ...
    public const STATUS_MANUAL_PROVISIONING = 'MANUAL_PROVISIONING';
    public const STATUS_PRODUCT_NOT_AVAILABLE = 'PRODUCT_NOT_AVAILABLE';
    public const STATUS_LIMIT_EXCEEDED = 'LIMIT_EXCEEDED';
    public const STATUS_VERIFICATION_REQUIRED = 'VERIFICATION_REQUIRED';
    public const STATUS_COMPLETED = 'COMPLETED';
    public const STATUS_ORDER_PROCESSING = 'ORDER_PROCESSING';
    ...
    */
    ...
    public function setTenantId($tenant_id)
    {
        ...
        if ((mb_strlen($tenant_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenant_id when calling UpgradeObjectStorageResponseData., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customer_id)
    {
        ...
        if ((mb_strlen($customer_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_id when calling UpgradeObjectStorageResponseData., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string $object_storage_id Object storage id
     *
     * @return self
     */
    public function setObjectStorageId($object_storage_id)
    {
        ...
        if ((mb_strlen($object_storage_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $object_storage_id when calling UpgradeObjectStorageResponseData., must be bigger than or equal to 1.');
        }
     ...
     * Sets created_date
     *
     * @param string $created_date Creation date for object storage.
     *
     * @return self
     */
     ...
     * Sets data_center
     *
     * @param string $data_center Data center of the object storage.
     *
     * @return self
     */
     ...
     * Gets auto_scaling
     *
     * @return \OpenAPI\Client\Model\UpgradeObjectStorageResponseDataAutoScaling
     */
     ...
     * Sets auto_scaling
     *
     * @param \OpenAPI\Client\Model\UpgradeObjectStorageResponseDataAutoScaling $auto_scaling auto_scaling
     *
     * @return self
     */
     ...
     *
     * @param float $total_purchased_space_tb Total purchased object storage space in TB.
     *
     * @return self
     */
    ...
    public function setDisplayName($display_name)
    {
        ...
        if ((mb_strlen($display_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $display_name when calling UpgradeObjectStorageResponseData., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($display_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $display_name when calling UpgradeObjectStorageResponseData., must be bigger than or equal to 1.');
        }
