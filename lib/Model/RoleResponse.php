    ...
    */
    ...
    public function setTenantId($tenant_id)
    {
        ...
        if ((mb_strlen($tenant_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenant_id when calling RoleResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customer_id)
    {
        ...
        if ((mb_strlen($customer_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_id when calling RoleResponse., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param bool $access_all_resources Access All Resources
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type Role type can be either `default` or `custom`. The `default` roles cannot be modified or deleted
     *
     * @return self
     */
