...
/**
 * ListPrivateNetworkResponseData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ListPrivateNetworkResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListPrivateNetworkResponseData';
    ...
    protected static $openAPITypes = [
        ...
        'instances' => '\OpenAPI\Client\Model\Instances[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('available_ips', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['available_ips'] === null) {
            $invalidProperties[] = "'available_ips' can't be null";
        }
    ...
    public function setTenantId($tenant_id)
    {
        ...
        if ((mb_strlen($tenant_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenant_id when calling ListPrivateNetworkResponseData., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customer_id)
    {
        ...
        if ((mb_strlen($customer_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_id when calling ListPrivateNetworkResponseData., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param int $private_network_id Private Network's id
     *
     * @return self
     */
     ...
     * Sets region_name
     *
     * @param string $region_name The region where your Private Network is located
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string $description The description of the Private Network
     *
     * @return self
     */
     ...
     * Sets cidr
     *
     * @param string $cidr The cidr range of the Private Network
     *
     * @return self
     */
    ...
    {
        return $this->container['available_ips'];
    }

    /**
     * Sets available_ips
     *
     * @param int $available_ips The total available IPs of the Private Network
     *
     * @return self
     */
    public function setAvailableIps($available_ips)
    {
        if (is_null($available_ips)) {
            throw new \InvalidArgumentException('non-nullable available_ips cannot be null');
        }
        $this->container['available_ips'] = $available_ips;
     ...
     * Sets created_date
     *
     * @param \DateTime $created_date The creation date of the Private Network
     *
     * @return self
     */
     ...
     * Gets instances
     *
     * @return \OpenAPI\Client\Model\Instances[]
     */
     ...
     * Sets instances
     *
     * @param \OpenAPI\Client\Model\Instances[] $instances instances
     *
     * @return self
     */
