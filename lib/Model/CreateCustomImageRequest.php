...
/**
 * CreateCustomImageRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateCustomImageRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateCustomImageRequest';
     ...
     * Sets os_type
     *
     * @param string $os_type Provided type of operating system (OS). Please specify `Windows` for MS Windows and `Linux` for other OS. Specifying wrong OS type may lead to disfunctional cloud instance.
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getOsTypeAllowableValues();
        if (!in_array($os_type, $allowedValues, true)) {
