 ...
 */
class VncResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VncResponse';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('vnc_ip', $data ?? [], null);
        $this->setIfExists('vnc_port', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['vnc_ip'] === null) {
            $invalidProperties[] = "'vnc_ip' can't be null";
        }
        if ($this->container['vnc_port'] === null) {
            $invalidProperties[] = "'vnc_port' can't be null";
        }
    ...
    public function setTenantId($tenant_id)
    {
        ...
        if ((mb_strlen($tenant_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenant_id when calling VncResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customer_id)
    {
        ...
        if ((mb_strlen($customer_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_id when calling VncResponse., must be bigger than or equal to 1.');
        }
     ...
     * Sets enabled
     *
     * @param bool $enabled VNC Status for the instance.
     *
     * @return self
     */
    ...
    {
        return $this->container['vnc_ip'];
    }

    /**
     * Sets vnc_ip
     *
     * @param string $vnc_ip VNC IP for the instance.
     *
     * @return self
     */
    public function setVncIp($vnc_ip)
    {
        if (is_null($vnc_ip)) {
            throw new \InvalidArgumentException('non-nullable vnc_ip cannot be null');
        }
        $this->container['vnc_ip'] = $vnc_ip;
     ...
     * Sets vnc_port
     *
     * @param float $vnc_port VNC Port for the instance.
     *
     * @return self
     */
    ...
    {
        if (is_null($vnc_port)) {
            throw new \InvalidArgumentException('non-nullable vnc_port cannot be null');
        }
