...
/**
 * UpdateObjectStorageResponseData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateObjectStorageResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateObjectStorageResponseData';
    ...
    protected static $openAPITypes = [
        ...
        'created_date' => 'string',
        'data_center' => 'string',
        'auto_scaling' => '\OpenAPI\Client\Model\UpdateObjectStorageResponseDataAutoScaling',
        's3_url' => 'string',
        'status' => 'string',
    ...
    public function setTenantId($tenant_id)
    {
        ...
        if ((mb_strlen($tenant_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenant_id when calling UpdateObjectStorageResponseData., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customer_id)
    {
        ...
        if ((mb_strlen($customer_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_id when calling UpdateObjectStorageResponseData., must be bigger than or equal to 1.');
        }
    ...
    public function setObjectStorageId($object_storage_id)
    {
        ...
        if ((mb_strlen($object_storage_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $object_storage_id when calling UpdateObjectStorageResponseData., must be bigger than or equal to 1.');
        }
     ...
     * Gets auto_scaling
     *
     * @return \OpenAPI\Client\Model\UpdateObjectStorageResponseDataAutoScaling
     */
     ...
     * Sets auto_scaling
     *
     * @param \OpenAPI\Client\Model\UpdateObjectStorageResponseDataAutoScaling $auto_scaling auto_scaling
     *
     * @return self
     */
     ...
     *
     * @param double $total_purchased_space_tb Total purchased object storage space in TB.
     *
     * @return self
     */
