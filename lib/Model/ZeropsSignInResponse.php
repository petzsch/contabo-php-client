...
/**
 * ZeropsSignInResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ZeropsSignInResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ZeropsSignInResponse';
    ...
    public function setTenantId($tenant_id)
    {
        ...
        if ((mb_strlen($tenant_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenant_id when calling ZeropsSignInResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customer_id)
    {
        ...
        if ((mb_strlen($customer_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_id when calling ZeropsSignInResponse., must be bigger than or equal to 1.');
        }
     ...
     * Sets url
     *
     * @param string $url URL to authenticate to Zerops
     *
     * @return self
     */
