...
/**
 * DpaServiceResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DpaServiceResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DpaServiceResponse';
    ...
    */
    ...
    public function setTenantId($tenant_id)
    {
        ...
        if ((mb_strlen($tenant_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenant_id when calling DpaServiceResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customer_id)
    {
        ...
        if ((mb_strlen($customer_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_id when calling DpaServiceResponse., must be bigger than or equal to 1.');
        }
     ...
     * Sets dpa_service_id
     *
     * @param string $dpa_service_id ID of the service
     *
     * @return self
     */
     ...
     * Sets service_name
     *
     * @param string $service_name Name of the product and service
     *
     * @return self
     */
     ...
     * Sets display_name
     *
     * @param string|null $display_name Display name of the service
     *
     * @return self
     */
     ...
     * Sets ip_address
     *
     * @param string|null $ip_address Optional Ip address of the service
     *
     * @return self
     */
