...
/**
 * SecretAuditResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SecretAuditResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SecretAuditResponse';
    ...
    public function setSecretId($secret_id)
    {
        ...
        if (($secret_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $secret_id when calling SecretAuditResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setTenantId($tenant_id)
    {
        ...
        if ((mb_strlen($tenant_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenant_id when calling SecretAuditResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customer_id)
    {
        ...
        if ((mb_strlen($customer_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_id when calling SecretAuditResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setChangedBy($changed_by)
    {
        ...
        if ((mb_strlen($changed_by) < 1)) {
            throw new \InvalidArgumentException('invalid length for $changed_by when calling SecretAuditResponse., must be bigger than or equal to 1.');
        }
