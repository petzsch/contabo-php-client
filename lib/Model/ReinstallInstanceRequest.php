...
/**
 * ReinstallInstanceRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ReinstallInstanceRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReinstallInstanceRequest';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['root_password'] = $data['root_password'] ?? null;
        $this->container['user_data'] = $data['user_data'] ?? null;
        $this->container['default_user'] = $data['default_user'] ?? 'admin';
    }
     ...
     * Sets image_id
     *
     * @param string $image_id ImageId to be used to setup the compute instance.
     *
     * @return self
     */
