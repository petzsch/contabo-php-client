...
/**
 * CustomerTypeBusiness Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CustomerTypeBusiness implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerTypeBusiness';
    ...
    */
     ...
     * Sets vat_id
     *
     * @param string $vat_id Company VAT ID
     *
     * @return self
     */
