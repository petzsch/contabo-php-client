...
/**
 * DpaAuditResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DpaAuditResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DpaAuditResponse';
    ...
    */
     ...
     * Sets dpa_id
     *
     * @param string $dpa_id The identifier of the Dpa
     *
     * @return self
     */
    ...
    public function setTenantId($tenant_id)
    {
        ...
        if ((mb_strlen($tenant_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenant_id when calling DpaAuditResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customer_id)
    {
        ...
        if ((mb_strlen($customer_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_id when calling DpaAuditResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setChangedBy($changed_by)
    {
        ...
        if ((mb_strlen($changed_by) < 1)) {
            throw new \InvalidArgumentException('invalid length for $changed_by when calling DpaAuditResponse., must be bigger than or equal to 1.');
        }
