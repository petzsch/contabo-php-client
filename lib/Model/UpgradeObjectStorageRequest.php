...
class UpgradeObjectStorageRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param float|null $total_purchased_space_tb New total object storage limit. If this number is larger than before you will also be billed for the added storage space. No downgrade possible.
     *
     * @return self
     */
