<?php
/**
 * ListInstancesActionsAuditResponseLinks
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ListInstancesActionsAuditResponseLinks Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ListInstancesActionsAuditResponseLinks implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListInstancesActionsAuditResponse__links';
    ...
    */
     ...
     * Sets first
     *
     * @param string $first Link to first page, if applicable.
     *
     * @return self
     */
     ...
     * Sets previous
     *
     * @param string|null $previous Link to previous page, if applicable.
     *
     * @return self
     */
     ...
     * Sets next
     *
     * @param string|null $next Link to next page, if applicable.
     *
     * @return self
     */
     ...
     * Sets last
     *
     * @param string $last Link to last page, if applicable.
     *
     * @return self
     */
