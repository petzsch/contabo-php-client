 ...
 */
class IpV4 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IpV4';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('netmask_cidr', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['netmask_cidr'] === null) {
            $invalidProperties[] = "'netmask_cidr' can't be null";
        }
    ...
    {
        return $this->container['netmask_cidr'];
    }

    /**
     * Sets netmask_cidr
     *
     * @param int $netmask_cidr Netmask CIDR
     *
     * @return self
     */
    public function setNetmaskCidr($netmask_cidr)
    {

        if (is_null($netmask_cidr)) {
            throw new \InvalidArgumentException('non-nullable netmask_cidr cannot be null');
        }

        $this->container['netmask_cidr'] = $netmask_cidr;
