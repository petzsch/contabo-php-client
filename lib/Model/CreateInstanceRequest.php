...
class CreateInstanceRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['image_id'] = $data['image_id'] ?? 'db1409d2-ed92-4f2f-978e-7b2fa4a1ec90';
        $this->container['product_id'] = $data['product_id'] ?? 'V1';
        ...
        $this->container['period'] = $data['period'] ?? 1;
