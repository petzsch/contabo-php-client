...
class InstanceResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'product_id' => 'string',
        'image_id' => 'string',
        'ip_config' => '\OpenAPI\Client\Model\IpConfig2',
        'mac_address' => 'string',
        'ram_mb' => 'float',
        'cpu_cores' => 'int',
        'os_type' => 'string',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['additional_ips'] = $data['additional_ips'] ?? null;
        ...
        $this->container['ip_config'] = $data['ip_config'] ?? null;
        $this->container['mac_address'] = $data['mac_address'] ?? null;
        $this->container['ram_mb'] = $data['ram_mb'] ?? null;
        $this->container['cpu_cores'] = $data['cpu_cores'] ?? null;
        $this->container['os_type'] = $data['os_type'] ?? null;
        $this->container['disk_mb'] = $data['disk_mb'] ?? null;
        ...
        $this->container['v_host_id'] = $data['v_host_id'] ?? null;
        ...
        $this->container['default_user'] = $data['default_user'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['default_user'] === null) {
            $invalidProperties[] = "'default_user' can't be null";
        }
    ...
    public function setTenantId($tenant_id)
    {
        ...
        if ((mb_strlen($tenant_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenant_id when calling InstanceResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customer_id)
    {
        ...
        if ((mb_strlen($customer_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_id when calling InstanceResponse., must be bigger than or equal to 1.');
        }
     ...
     * Gets ip_config
     *
     * @return \OpenAPI\Client\Model\IpConfig2|null
     */
     ...
     * Sets ip_config
     *
     * @param \OpenAPI\Client\Model\IpConfig2|null $ip_config ip_config
     *
     * @return self
     */
    ...
    public function setCancelDate($cancel_date)
    {
        if ((mb_strlen($cancel_date) > 10)) {
            throw new \InvalidArgumentException('invalid length for $cancel_date when calling InstanceResponse., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($cancel_date) < 0)) {
            throw new \InvalidArgumentException('invalid length for $cancel_date when calling InstanceResponse., must be bigger than or equal to 0.');
        }
        if ((!preg_match("/yyyy-mm-dd/", $cancel_date))) {
            throw new \InvalidArgumentException("invalid value for $cancel_date when calling InstanceResponse., must conform to the pattern /yyyy-mm-dd/.");
        }
