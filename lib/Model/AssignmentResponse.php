...
class AssignmentResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['tag_name']) > 255)) {
            $invalidProperties[] = "invalid value for 'tag_name', the character length must be smaller than or equal to 255.";
        }

        if ((mb_strlen($this->container['tag_name']) < 1)) {
            $invalidProperties[] = "invalid value for 'tag_name', the character length must be bigger than or equal to 1.";
        }

        if ($this->container['resource_type'] === null) {
            $invalidProperties[] = "'resource_type' can't be null";
        }
        if ((mb_strlen($this->container['resource_type']) < 1)) {
            $invalidProperties[] = "invalid value for 'resource_type', the character length must be bigger than or equal to 1.";
        }

        if ($this->container['resource_id'] === null) {
            $invalidProperties[] = "'resource_id' can't be null";
        }
        if ((mb_strlen($this->container['resource_id']) < 1)) {
            $invalidProperties[] = "invalid value for 'resource_id', the character length must be bigger than or equal to 1.";
        }

        if ($this->container['resource_name'] === null) {
            $invalidProperties[] = "'resource_name' can't be null";
        }
        if ((mb_strlen($this->container['resource_name']) < 1)) {
            $invalidProperties[] = "invalid value for 'resource_name', the character length must be bigger than or equal to 1.";
        }
    ...
    public function setTenantId($tenant_id)
    {
        ...
        if ((mb_strlen($tenant_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenant_id when calling AssignmentResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customer_id)
    {
        ...
        if ((mb_strlen($customer_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_id when calling AssignmentResponse., must be bigger than or equal to 1.');
        }
     ...
     * Sets tag_name
     *
     * @param string $tag_name Tag's name
     *
     * @return self
     */
    public function setTagName($tag_name)
    {
        if ((mb_strlen($tag_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $tag_name when calling AssignmentResponse., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($tag_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tag_name when calling AssignmentResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setResourceType($resource_type)
    {
        ...
        if ((mb_strlen($resource_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $resource_type when calling AssignmentResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setResourceId($resource_id)
    {
        ...
        if ((mb_strlen($resource_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $resource_id when calling AssignmentResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setResourceName($resource_name)
    {
        ...
        if ((mb_strlen($resource_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $resource_name when calling AssignmentResponse., must be bigger than or equal to 1.');
        }
