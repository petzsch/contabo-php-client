...
```php
retrieveDpaAuditsList($x_request_id, $x_trace_id, $page, $size, $order_by, $dpa_id, $request_id, $changed_by, $start_date, $end_date): \OpenAPI\Client\Model\ListDpaAuditResponse
```
...
$apiInstance = new OpenAPI\Client\Api\DpaAuditsApi(
...
$dpa_id = 1b943b25a-c8b5-4570-9135-4bbaa7615b812345; // string | The identifier of the Dpa.
...
try {
    $result = $apiInstance->retrieveDpaAuditsList($x_request_id, $x_trace_id, $page, $size, $order_by, $dpa_id, $request_id, $changed_by, $start_date, $end_date);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DpaAuditsApi->retrieveDpaAuditsList: ', $e->getMessage(), PHP_EOL;
}
```
...
| **dpa_id** | **string**| The identifier of the Dpa. | [optional] |
...
[**\OpenAPI\Client\Model\ListDpaAuditResponse**](../Model/ListDpaAuditResponse.md)
